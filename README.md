<h1 align="center">
  CRUD em React, .NET CORE e integração com API Correios
</h1>
...
<h5>Frontend:</h5>
<p>Abrir o terminal no diretório frontend do projeto e digitar: 
...
Adicionar e Deletar contatos a sua agenda
além de poder cadastrar seus compromissos(em manutenção)
Pesquisar seu CEP e ter seu endereço preenchido automaticamente com a ajuda do serviço de busca da API Correios.
</p>
